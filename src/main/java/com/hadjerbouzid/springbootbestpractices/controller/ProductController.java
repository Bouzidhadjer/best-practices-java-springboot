package com.hadjerbouzid.springbootbestpractices.controller;

import com.hadjerbouzid.springbootbestpractices.dto.APIResponse;
...
public class ProductController {
    ...
    public  ResponseEntity<APIResponse> getProducts() {
        ...
        APIResponse<List<ProductResponseDTO>> responseDTO = APIResponse
                .<List<ProductResponseDTO>>builder().status(SUCCESS).results(products).build();
    ...
    public ResponseEntity<APIResponse> getProduct(@PathVariable long productId) {
        ...
        APIResponse<ProductResponseDTO> responseDTO = APIResponse.<ProductResponseDTO>builder()
                ...
                .results(product)
                .build();
        log.info("ProductController::getProduct by id response {}", productId, ValueMapper.jsonAsString(responseDTO));
        return new ResponseEntity<>(responseDTO,HttpStatus.OK);
    }
    ...
    public ResponseEntity<APIResponse> getProductsGroupByType() {
        ...
        APIResponse<Map<String, List<ProductResponseDTO>>> responseDTO = APIResponse
                ...
                .results(products)
                .build();
        log.info("ProductController::getProductsGroupByTypes by types {}", ValueMapper.jsonAsString(products));
        return  new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
